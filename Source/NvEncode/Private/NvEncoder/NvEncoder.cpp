...
#if defined(_WIN32)
    NvEncodeAPIGetMaxSupportedVersion_Type NvEncodeAPIGetMaxSupportedVersion = (NvEncodeAPIGetMaxSupportedVersion_Type)(void*)GetProcAddress(hModule, "NvEncodeAPIGetMaxSupportedVersion");
#else
...
void NvEncoder::CreateEncoder(const NV_ENC_INITIALIZE_PARAMS* pEncoderParams)
{
    ...
    {
        m_vpCompletionEvent[i] = CreateEvent(NULL, 0, 0, NULL);
